                   ...
                   <div class="col-lg-4" style = "width: 505px;">
                    <div class="card mb-3" style = "width: 505px;">
                      ...
                      <div class="card-body" style = "width: 505px;">
                        <form action="SearchAccController.php" method="POST" class="d-none d-md-inline-block form-inline ml-auto mr-0 mr-md-3 my-2 my-md-0">
                      ...
                      <div class="input-group-append">
                        <button name = "submit" type="submit" name="Search User" class="btn btn-primary">
