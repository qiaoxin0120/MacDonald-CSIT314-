...
<html>
    ...
    <?php
     ...
     if (isset($_GET['reportDate'])) {
        ...
        //Average Spend 
        include('averageDailyController.php');
        include('averageWeeklyController.php');
        include('averageMonthlyController.php');

        $averageDailyController = new averageSpendDailyReport();
        $averageWeeklyController = new averageSpendWeeklyReport();
        $averageMonthlyController = new averageSpendMonthlyReport();

        $averageSpendDailyReport = $averageDailyController -> getAverageSpendDailyReport($_GET['reportDate']);
        $averageSpendWeeklyReport = $averageWeeklyController -> getAverageSpendWeeklyReport($_GET['reportDate']);
        $averageSpendMonthlyReport = $averageMonthlyController -> getAverageSpendMonthlyReport($_GET['reportDate']);

        //Frequency Per Visit 
        include('frequencyDailyController.php');
        include('frequencyWeeklyController.php');
        include('frequencyMonthlyController.php');

        $frequencyDailyReport = new frequencyPerVisitDailyReport();
        $frequencyWeeklyReport = new frequencyPerVisitWeeklyReport();
        $frequencyMonthlyReport = new frequencyPerVisitMonthlyReport();        

        $frequencyPerVisitDailyReport = $frequencyDailyReport -> getFrequencyPerVisitDailyReport($_GET['reportDate']);
        $frequencyPerVisitWeeklyReport = $frequencyWeeklyReport -> getFrequencyPerVisitWeeklyReport($_GET['reportDate']);
        $frequencyPerVisitMonthlyReport = $frequencyMonthlyReport -> getFrequencyPerVisitMonthlyReport($_GET['reportDate']);
        
        //Preferences For Dishes
        include('preferencesForDishesDailyController.php');
        include('preferencesForDishesWeeklyController.php');
        include('preferencesForDishesMonthlyController.php');

        $preferencesDailyReport = new preferencesForDishesDailyReport();
        $preferencesWeeklyReport = new preferencesForDishesWeeklyReport();
        $preferencesMonthlyReport = new preferencesForDishesMonthlyReport();        

        $preferencesForDishesDailyReport = $preferencesDailyReport -> getPreferencesForDishesDailyReport($_GET['reportDate']);
        $preferencesForDishesWeeklyReport = $preferencesWeeklyReport -> getPreferencesForDishesWeeklyReport($_GET['reportDate']);
        $preferencesForDishesMonthlyReport = $preferencesMonthlyReport -> getPreferencesForDishesMonthlyReport($_GET['reportDate']);
