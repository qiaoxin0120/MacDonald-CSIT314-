...
<html>
  ...
  <head>
    <title> Explore | Food in Break First </title>
  </head>
...
<h5 class="text-danger">S$ <?php echo $row["price"]; ?></h5>
...
else
{
  ...
  <div class="container">
    <div class="jumbotron">
      <center>
         <label style="margin-left: 5px;color: red;"> <h1>Oops! Food is unavailable now.</h1> </label>
        <p>Stay Hungry...! :P</p>
      </center>
